...
@register_command("tools", "Run AKB maintenance tools")
def build_parser(subparsers: object) -> None:
    parser = subparsers.add_parser("tools", help="Run AKB maintenance tools")
    tool_subparsers = parser.add_subparsers(dest="tool_command", required=True)

    git_safe = tool_subparsers.add_parser("add-git-safe", help="Add directories to global Git safe.directory")
